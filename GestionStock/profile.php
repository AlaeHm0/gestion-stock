                    ...
                    <div class="col-md-6">
                        <div class="profile-head">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Statique</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <a href="paramettre.php"><input type="button" class="profile-edit-btn" name="btnAddMore" value="Edit Profile"/></a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="tab-content profile-tab" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p><?php echo $total_expedition + $total_reception ?></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label>Total Reception</label>
                                            </div>
                                            <div class="col-md-6">
                                                <p><?php 
                                                
                                                echo $total_reception;
                                                ?></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label>Total Expedition</label>
                                            </div>
                                            <div class="col-md-6">
                                                <p><?php
                                                
                                                echo $total_expedition;
                                                ?></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label>Registre Depuis</label>
                                            </div>
                                            <div class="col-md-6">
                                                <p><?php 
                                                $curr_time = date('Y-m-d');
                                                // Current Time
                                                $time1 = DateTime::createFromFormat('Y-m-d', $curr_time);
                                                // Time of The Alert
                                                $time2 = DateTime::createFromFormat('Y-m-d', $date_registre);
