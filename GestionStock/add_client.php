        ...
        <div class="right_col">
            <div>
                ...
                <div class="x_content">
                    <div class="row">
                        <div class="col-sm-6">
                            <a href="list_client.php" class="btn btn-info">Liste des Clients</a>
                            <div class="form-group">
                                ...
                                <button class="btn btn-primary mt-2" id="submit" onclick="ajouterClient()">Ajouter</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        function ajouterClient(){
            ...
            if( ice && nom && email && phone && adresse){
                if(ice.length == 15 && ice == parseInt(ice)){ // check if ice is form of 15 numbers
                    $.ajax({
                        url : "request/ajouter_client.php",
                        method : 'post',
                        data : {
                            id : id,
                            ice : ice,
                        ...
                        success : function(msg){
                            alert(msg)
                            window.location = 'list_client.php'
                        },
                        error : function(){
