...
<head>
  ...
  <body class="nav-md">
        ...
        <div class="right_col">
            <div>
                ...
                <div class="x_content">
                    <div class="row">
                        <div class="col-sm-12">
                            <a href="add_fornisseur.php" class="btn btn-info">Ajouter Fornisseur</a>
                            <div class="card-box table-responsive">
                                <table id="datatable-buttons" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        $result = mysqli_query($conn, "SELECT * FROM fornisseur");
    ...
    <script>
        ...
        function supprimerFornisseur(id){
            let confirm = window.confirm("Are you sure!")
            if(confirm){
                $.ajax({
                    url : "request/supprimer_fornisseur.php",
                    method : 'post',
                    data : {
                        id : id
                    },
